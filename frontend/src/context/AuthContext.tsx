...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const logout = () => {
    const isSSO = localStorage.getItem('login_method') === 'sso';
    ...
    if (isSSO) {
      ...
      // Providing id_token_hint allows for a direct logout without confirmation
      let logoutUrl = `http://10.26.192.122:8080/realms/Central-SSWAuth/protocol/openid-connect/logout?post_logout_redirect_uri=${encodeURIComponent('http://172.16.49.132:8083/login')}&client_id=duty-chart`;
