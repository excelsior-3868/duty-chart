...
if DEBUG:
    ...
    cors_origins = os.environ.get("CORS_ALLOWED_ORIGINS", "http://localhost:3000,http://127.0.0.1:3000,http://10.26.204.149:3000")
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'duty_chart_db'),
